...
# 🔹 Step 2: Scale features (Lasso is sensitive to scale)
scaler = StandardScaler()
X_train_scaled = scaler.fit_transform(X_train)
X_test_scaled  = scaler.transform(X_test)

# 🔹 Step 3: Initialize and train Lasso Regression
...
joblib.dump(lasso, os.path.join(models_path, "lasso_model.pkl"))
print("\n✅ Model saved as 'lasso_model.pkl' in the models folder.")
