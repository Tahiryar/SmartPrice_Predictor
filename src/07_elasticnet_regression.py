...
# 🔹 Step 2: Scale features (ElasticNet sensitive to scale)
scaler = StandardScaler()
X_train_scaled = scaler.fit_transform(X_train)
X_test_scaled  = scaler.transform(X_test)

# 🔹 Step 3: Initialize and train ElasticNet Regression
...
joblib.dump(en, os.path.join(models_path, "elasticnet_model.pkl"))
print("\n✅ Model saved as 'elasticnet_model.pkl' in the models folder.")
