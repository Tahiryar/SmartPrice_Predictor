...
# 🔹 Step 2: Scale features for SVR
scaler = StandardScaler()
X_train_scaled = scaler.fit_transform(X_train)
X_test_scaled  = scaler.transform(X_test)

# 🔹 Step 3: Initialize and train SVR with RBF kernel
...
joblib.dump(svr, os.path.join(models_path, "svr_rbf_model.pkl"))
print("\n✅ Model saved as 'svr_rbf_model.pkl' in the models folder.")
